...
namespace AzureMobile.Samples.FieldEngineer
{
    ...
    /// </summary>
    public sealed partial class InternetErrorPage : CapptainPage
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public InternetErrorPage()
        {
        ...
        {
            //Check whether internet connection is there in online mode. If not switch it offline mode.
