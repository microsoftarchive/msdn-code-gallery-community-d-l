...
{
  /// <summary>
  /// Capptain grid for overlay insertion of notification
  /// </summary>
  public sealed partial class CapptainOverlayNotification : Grid
  {
    private static CapptainOverlayNotification instance;

    /// <summary>
    /// Singleton instance
    /// </summary>
    public static CapptainOverlayNotification Instance
    {
      get
      {
        if (instance == null)
        {
          instance = new CapptainOverlayNotification();
        }
        return instance;
      }
    }
    ...
    /// </summary>
    private CapptainOverlayNotification()
    {
    ...
    {
      this.capptain_notification_content.Width = Window.Current.Bounds.Width;
      this.capptain_notification_content.Height = 64;
    }
    ...
    {
      this.capptain_notification_content.Width = width;
    }
