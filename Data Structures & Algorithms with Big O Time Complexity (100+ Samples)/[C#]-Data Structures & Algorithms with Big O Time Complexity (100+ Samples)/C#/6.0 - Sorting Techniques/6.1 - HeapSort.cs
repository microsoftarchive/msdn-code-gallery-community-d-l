...
*/
    ...
    partial class SortingSamples
    {
        ...
        {
            // 1. Validate Input
            if (listToSort == null || listToSort.Length <= 1)
                return;

            int currentHeapSize = listToSort.Length;

            //BuildMaxHeap(listToSort, currentHeapSize);
            int parentIndex = currentHeapSize / 2; // Start from mid array.
        ...
        public void Heapify(int[] listToSort, int parentIndex, int currentHeapSize)
        {
            ...
            int rightChildIndex = leftChildIndex + 1; // OR 2 * parentIndex + 2;

            if (leftChildIndex < currentHeapSize && listToSort[leftChildIndex] > listToSort[parentIndex])
            {
