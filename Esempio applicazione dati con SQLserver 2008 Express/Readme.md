...
namespace SqlServer_example
{
    ...
    public partial class FrmMain : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            // Passo al metodo insertData i parametri necessari per la memorizzazione del Nome,Cognome e Et&agrave; all'interno della
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            // Passo al metodo deleteData i parametri necessari per la memorizzazione del Nome,Cognome e Et&agrave; all'interno della
            // Tabella del DataBase
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            // Passo al metodo updateData i parametri necessari per la memorizzazione del Nome,Cognome e Et&agrave; all'interno della
            // Tabella del DataBase
        ...
        private void btnFindTypeData_Click(object sender, EventArgs e)
        {
            ...
            switch (this.cbxTypeData.Text)
            {
                ...
                case &quot;NAME&quot;:
                    ...
                    // Assegno il risultato della query alla propriet&agrave; DataSource del controllo
                ...
                // Se valore AGE
                case &quot;AGE&quot;:
                    // Eseguo la query di ricerca LinqToDataSet per et&agrave;
        ...
        private void btnFindLinq_Click(object sender, EventArgs e)
        {
            ...
            switch (cbxLinq.Text)
            {
                ...
                case &quot;ASCENDING AGE&quot;:
                    // Eseguo la query di ricerca LinqToDataSet per et&agrave; e ordino il 
                    // Risultato in senso crescente
...
namespace SqlServer_example
{
    ...
    class DatabaseManagement
    {
        ...
        // Metodo insertData , richiede tre parametri , il nome , il cognome , l'et&agrave; per l'inserimento all'interno del DataBase
        ...
        // Metodo deleteData , richiede tre parametri , il nome , il cognome , l'et&agrave; per l'inserimento all'interno del DataBase
        ...
        // Metodo updateData , richiede tre parametri , il nome , il cognome , l'et&agrave; per l'inserimento all'interno del DataBase
...
<span class="cs__keyword">using</span>&nbsp;System.Data.Sql;&nbsp;
<span class="cs__keyword">using</span>&nbsp;System.Data.SqlTypes;&nbsp;
<span class="cs__keyword">using</span>&nbsp;System.Windows.Forms;&nbsp;
<span class="cs__keyword">using</span>&nbsp;System.Data;&nbsp;
&nbsp;
<span class="cs__com">//&nbsp;Spazio&nbsp;dei&nbsp;nomi&nbsp;SqlSever_example</span>&nbsp;
