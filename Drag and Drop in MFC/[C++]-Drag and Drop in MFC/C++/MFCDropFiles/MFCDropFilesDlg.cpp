...
// MFCDropFilesDlg.cpp : implementation file
//

#include "stdafx.h"
#include "MFCDropFiles.h"
#include "MFCDropFilesDlg.h"
...
CMFCDropFilesDlg::CMFCDropFilesDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMFCDropFilesDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFCDropFilesDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
// CMFCDropFilesDlg message handlers
...
void CMFCDropFilesDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CMFCDropFilesDlg::OnQueryDragIcon()
{
