...
<div class="main">
 	...
 	<% 
		...
		if(userPage == null){
			out.println("Sorry! Error Encountered While retrieving users! Please try Again!");
			return;
		}
		...
		for(int i = 0; i < userPage.getUserNumber(); i++){
			...
			//out.println("<td style=\"color:red\"> <a class=\"users\" href='/JavaSampleApp/requestHandler?op=deleteUser&ObjectId=" + userPage.getUserObjectId(i)+"'><i> delete </i>" + "</a></td>");
			out.println("</tr>");
		}
