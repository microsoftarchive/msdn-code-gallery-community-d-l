...
<h1 class="heading"> Windows Azure Active Directory Graph Sample Application Ver1.5</h1>
...
<div class="main">
	...
	<form action="index.jsp">
		<input style="margin-left:400px;margin-top:10px" class="button" type="Submit" value="OK">
	</form>
