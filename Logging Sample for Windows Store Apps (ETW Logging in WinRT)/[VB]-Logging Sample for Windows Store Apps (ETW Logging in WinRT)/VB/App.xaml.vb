...
NotInheritable Class App
    ...
    Protected Overrides Sub OnLaunched(args As Windows.ApplicationModel.Activation.LaunchActivatedEventArgs)
        ...
        If rootFrame.Content Is Nothing Then
            ...
            Dim verboseListener As EventListener = New StorageFileEventListener("MyListenerVerbose")
            Dim informationListener As EventListener = New StorageFileEventListener("MyListenerInformation")
