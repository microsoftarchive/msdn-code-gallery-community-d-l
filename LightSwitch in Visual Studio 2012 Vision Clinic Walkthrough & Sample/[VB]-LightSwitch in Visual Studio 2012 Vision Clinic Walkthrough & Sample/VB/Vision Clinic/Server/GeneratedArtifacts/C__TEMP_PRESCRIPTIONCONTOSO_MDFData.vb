...
<Assembly: EdmSchemaAttribute("f1bd3713-c6e4-4ef3-9088-8b0bb1be2c29")>
#Region "EDM Relationship Metadata"
<Assembly: EdmRelationshipAttribute("LightSwitchApplication", "FK_Product_ProductRebate", "Product", System.Data.Metadata.Edm.RelationshipMultiplicity.One, GetType(C__TEMP_PRESCRIPTIONCONTOSO_MDFData.Implementation.Product), "ProductRebate", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(C__TEMP_PRESCRIPTIONCONTOSO_MDFData.Implementation.ProductRebate), True)>

#End Region

Namespace C__TEMP_PRESCRIPTIONCONTOSO_MDFData.Implementation
    ...
    ''' </summary>
    Public Partial Class C__TEMP_PRESCRIPTIONCONTOSO_MDFDataObjectContext
        Inherits ObjectContext
    
        #Region "Constructors"
    
        ''' <summary>
        ''' Initializes a new C__TEMP_PRESCRIPTIONCONTOSO_MDFDataObjectContext object using the connection string found in the 'C__TEMP_PRESCRIPTIONCONTOSO_MDFDataObjectContext' section of the application configuration file.
        ''' </summary>
        Public Sub New()
            MyBase.New("name=C__TEMP_PRESCRIPTIONCONTOSO_MDFDataObjectContext", "C__TEMP_PRESCRIPTIONCONTOSO_MDFDataObjectContext")
            OnContextCreated()
        End Sub
        ...
        Public Sub New(ByVal connectionString As String)
            MyBase.New(connectionString, "C__TEMP_PRESCRIPTIONCONTOSO_MDFDataObjectContext")
            OnContextCreated()
        End Sub
        ...
        Public Sub New(ByVal connection As EntityConnection)
            MyBase.New(connection, "C__TEMP_PRESCRIPTIONCONTOSO_MDFDataObjectContext")
            OnContextCreated()
        End Sub
