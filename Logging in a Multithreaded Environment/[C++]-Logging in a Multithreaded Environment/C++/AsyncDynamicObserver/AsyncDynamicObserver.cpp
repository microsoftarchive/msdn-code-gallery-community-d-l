/**********************************************************************
*
* AsyncDynamicObserver.cpp: Definition of AsyncDynamicObserver
*
...
#include "AsyncDynamicObserver.h"
...
BEGIN_MESSAGE_MAP(AsyncDynamicObserverApp, CWinApp)
	//{{AFX_MSG_MAP(AsyncDynamicObserverApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only AsyncDynamicObserverApp object

AsyncDynamicObserverApp theApp;

/**********************************************************************
*
* AsyncDynamicObserverApp::InitInstance
*
...
*
**********************************************************************/
BOOL AsyncDynamicObserverApp::InitInstance()
{
...
/**********************************************************************
*
* AsyncDynamicObserverApp::ExitInstance
*
...
*
**********************************************************************/
int AsyncDynamicObserverApp::ExitInstance() 
{
...
/**********************************************************************
*
* AsyncDynamicObserverApp::OnAppAbout
*
* Description: Message handling ID_APP_ABOUT: Shows the About dialog
*
**********************************************************************/
void AsyncDynamicObserverApp::OnAppAbout()
{
	AboutDlg aboutDlg;
...
/**********************************************************************
*
* AsyncDynamicObserverApp::OnConfigObserver
*
* Description: Message handling IDM_CONFIG_OBSERVER: 
*   Shows the observer config sheet
*
**********************************************************************/
void AsyncDynamicObserverApp::OnConfigObserver() 
{
...
/**********************************************************************
*
* AsyncDynamicObserverApp::OnLogUserActivity
*
* Description: Message handling IDM_LOG_GUI: 
*   Creates a log message of the user activity area
*
**********************************************************************/
void AsyncDynamicObserverApp::OnLogUserActivity() 
{
