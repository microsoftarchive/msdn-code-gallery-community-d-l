...
BEGIN_MESSAGE_MAP(PpCfgObserver, CPropertyPage)
  ...
  ON_NOTIFY(LVN_ITEMCHANGED, IDC_LBX_OBSERVER, OnItemChangedLbxObserver)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/**********************************************************************
*
* PpCfgObserver::OnItemChangedLbxObserver
*
* Description: Handles SelChange of the observer list
*
* Comment: Activates the remove button
*
**********************************************************************/
void PpCfgObserver::OnItemChangedLbxObserver
  (
  NMHDR* pNMHDR, 
  LRESULT* pResult
  ) 
{
  ...
  if (!(pNMListView->uNewState & LVIS_SELECTED))
    goto OnItemChangedLbxObserverEnd;

  m_btnRemove.EnableWindow(TRUE);
    
OnItemChangedLbxObserverEnd:	
	*pResult = 0;
}
