<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shanuBarchart.aspx.cs" Inherits="ShanuHTML5Chart_VS2013.ShanuCharts.shanuBarchart"  MasterPageFile="~/Site.master"  %>
...
onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" >7</asp:TextBox><br />
   ...
   <img src="../images/Bar.png"  onClick="drawChart()" alt="Click to Draw PIE Chart" />
     ...
     <img src="../images/Save.png"  onClick="ShanuSaveImage()" alt="Click to Save PIE Chart" />
        ...
        <asp:TextBox ID="txtTitle" runat="server" Height="26px" MaxLength="40" Width="140px" >SHANU Bar Chart</asp:TextBox><br />
                 </td>
                                 <td  style="background-color:#ECF3F4;border-right:1px solid #C7C7C7;" >
                                     Chart WaterMark:
