...
<p><strong><em>System.ServiceModel.ProtocolException: The content type text/xml of the response message does not match the content type of the binding (application/soap&#43;xml; charset=utf-8). If using a custom encoder, be sure that the IsContentTypeSupported
