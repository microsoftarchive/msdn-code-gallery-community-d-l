Namespace ClientSample
	Partial Public Class Login
		...
		Private Sub InitializeComponent()
			...
			Me.cbxServerType = New System.Windows.Forms.ComboBox()
...
'			Me.btnLogin.Click += New System.EventHandler(Me.btnLogin_Click)
			...
			' loginPage
			' 
			Me.loginPage.Controls.Add(Me.lblProtocol)
			Me.loginPage.Controls.Add(Me.cbxServerType)
			...
			' lblProtocol
			' 
			Me.lblProtocol.Location = New System.Drawing.Point(320, 60)
			Me.lblProtocol.Name = "lblProtocol"
			Me.lblProtocol.Size = New System.Drawing.Size(52, 13)
			Me.lblProtocol.TabIndex = 121
			Me.lblProtocol.Text = "Protocol:"
			' 
			' cbxServerType
			' 
			Me.cbxServerType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
			Me.cbxServerType.FormattingEnabled = True
			Me.cbxServerType.Items.AddRange(New Object() { "Auto Detect", "FTP", "SFTP"})
			Me.cbxServerType.Location = New System.Drawing.Point(376, 56)
			Me.cbxServerType.Name = "cbxServerType"
			Me.cbxServerType.Size = New System.Drawing.Size(99, 21)
			Me.cbxServerType.TabIndex = 120
			' 
			' sftp
			' 
...
'			Me.cbxProxyType.SelectedIndexChanged += New System.EventHandler(Me.cbxProxy_SelectedIndexChanged)
		...
		Private cbxServerType As ComboBox
		Private lblProtocol As Label
	End Class
End Namespace