...
#If FTP AndAlso SFTP Then
			_loginSettings.LoadConfig(AddressOf LoginInfo.LoadConfig, FtpLoginInfo.LoadConfig, AddressOf SftpLoginInfo.LoadConfig)
			_settings.LoadConfig(AddressOf SettingInfo.LoadConfig, FtpSettingInfo.LoadConfig, AddressOf SftpSettingInfo.LoadConfig)
#ElseIf FTP Then
			_loginSettings.LoadConfig(AddressOf LoginInfo.LoadConfig, FtpLoginInfo.LoadConfig)
			_settings.LoadConfig(AddressOf SettingInfo.LoadConfig, FtpSettingInfo.LoadConfig)
#ElseIf SFTP Then
			_loginSettings.LoadConfig(AddressOf LoginInfo.LoadConfig, AddressOf SftpLoginInfo.LoadConfig)
			_settings.LoadConfig(AddressOf SettingInfo.LoadConfig, AddressOf SftpSettingInfo.LoadConfig)
#End If
...
#If FTP AndAlso SFTP Then
			_loginSettings.SaveConfig(AddressOf LoginInfo.SaveConfig, FtpLoginInfo.SaveConfig, AddressOf SftpLoginInfo.SaveConfig)
			_settings.SaveConfig(AddressOf SettingInfo.SaveConfig, FtpSettingInfo.SaveConfig, AddressOf SftpSettingInfo.SaveConfig)
#ElseIf FTP Then
			_loginSettings.SaveConfig(AddressOf LoginInfo.SaveConfig, FtpLoginInfo.SaveConfig)
			_settings.SaveConfig(AddressOf SettingInfo.SaveConfig, FtpSettingInfo.SaveConfig)
#ElseIf SFTP Then
			_loginSettings.SaveConfig(AddressOf LoginInfo.SaveConfig, AddressOf SftpLoginInfo.SaveConfig)
			_settings.SaveConfig(AddressOf SettingInfo.SaveConfig, AddressOf SftpSettingInfo.SaveConfig)
#End If
