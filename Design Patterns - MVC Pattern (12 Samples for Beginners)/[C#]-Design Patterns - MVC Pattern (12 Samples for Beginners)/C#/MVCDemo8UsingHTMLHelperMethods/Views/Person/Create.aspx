...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        Here are we are using HTML EditorFor,LabelFor,TextBoxFor and ValidationMessageFor
        helper method to create the View Controls and perform some validations and using
        some action links
        <br />
</asp:Content>