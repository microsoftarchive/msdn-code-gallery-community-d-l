    ...
    $.extend($.jqx._jqxComboBox.prototype, {
        ...
        render: function () {
            ...
            if (nodeName == "select" || nodeName == "ul" || nodeName == "ol") {
                ...
                me.element.style.cssText = me.field.style.cssText;
            ...
            me.dropdownlistContent.append($('<input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="box-sizing: border-box; margin: 0; padding: 0; padding-left: 3px; padding-right: 3px; border: 0;" type="textarea"/>'));
            ...
            me.addHandler(me.input, 'keyup.textchange', function (event) {
                if (me._writeTimer) clearTimeout(me._writeTimer);
                me._writeTimer = setTimeout(function () {
