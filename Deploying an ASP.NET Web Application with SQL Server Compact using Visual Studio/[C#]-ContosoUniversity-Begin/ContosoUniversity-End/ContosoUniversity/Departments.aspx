...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Departments</h2> 
    Enter a department name or leave the box blank to see all names: 
    ...
    <asp:GridView ID="DepartmentsGridView" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns> 
            ...
            <asp:TemplateField HeaderText="Administrator" SortExpression="Person.LastName" ItemStyle-VerticalAlign="Top" > 
                <ItemTemplate> 
                    <asp:Label ID="AdministratorLastNameLabel" runat="server" Text='<%# Eval("Administrator.FullName") %>'></asp:Label>, 
                </ItemTemplate> 
                <EditItemTemplate> 
                    <asp:ObjectDataSource ID="InstructorsObjectDataSource" runat="server" DataObjectTypeName="ContosoUniversity.DAL.Instructor" 
                        SelectMethod="GetInstructors" TypeName="ContosoUniversity.BLL.SchoolBL"> 
                    </asp:ObjectDataSource> 
                    <asp:DropDownList ID="InstructorsDropDownList" runat="server" DataSourceID="InstructorsObjectDataSource" 
                        SelectedValue='<%# Eval("Administrator.PersonID")  %>' 
