...
// 
namespace FlashCards.ViewModel.FlashService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="FlashService.IFlashCardService")]
    public interface IFlashCardService {
        ...
        System.IAsyncResult BeginUploadFile(FlashCards.ViewModel.FlashService.UploadFileContentMessage request, System.AsyncCallback callback, object asyncState);
        
        FlashCards.ViewModel.FlashService.UploadFileTokenMessage EndUploadFile(System.IAsyncResult result);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IFlashCardServiceChannel : FlashCards.ViewModel.FlashService.IFlashCardService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FlashCardServiceClient : System.ServiceModel.ClientBase<FlashCards.ViewModel.FlashService.IFlashCardService>, FlashCards.ViewModel.FlashService.IFlashCardService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult FlashCards.ViewModel.FlashService.IFlashCardService.BeginUploadFile(FlashCards.ViewModel.FlashService.UploadFileContentMessage request, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult BeginUploadFile(byte[] FileByteStream, System.AsyncCallback callback, object asyncState) {
            FlashCards.ViewModel.FlashService.UploadFileContentMessage inValue = new FlashCards.ViewModel.FlashService.UploadFileContentMessage();
            inValue.FileByteStream = FileByteStream;
            return ((FlashCards.ViewModel.FlashService.IFlashCardService)(this)).BeginUploadFile(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FlashCards.ViewModel.FlashService.UploadFileTokenMessage FlashCards.ViewModel.FlashService.IFlashCardService.EndUploadFile(System.IAsyncResult result) {
            return base.Channel.EndUploadFile(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private string EndUploadFile(System.IAsyncResult result) {
            FlashCards.ViewModel.FlashService.UploadFileTokenMessage retVal = ((FlashCards.ViewModel.FlashService.IFlashCardService)(this)).EndUploadFile(result);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult FlashCards.ViewModel.FlashService.IFlashCardService.BeginGetFileUri(string senderName, string password, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetFileUri(senderName, password, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string FlashCards.ViewModel.FlashService.IFlashCardService.EndGetFileUri(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetFileUri(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((FlashCards.ViewModel.FlashService.IFlashCardService)(this)).BeginGetFileUri(senderName, password, callback, asyncState);
        }
        
        private object[] OnEndGetFileUri(System.IAsyncResult result) {
            string retVal = ((FlashCards.ViewModel.FlashService.IFlashCardService)(this)).EndGetFileUri(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override FlashCards.ViewModel.FlashService.IFlashCardService CreateChannel() {
            return new FlashCardServiceClientChannel(this);
        }
        
        private class FlashCardServiceClientChannel : ChannelBase<FlashCards.ViewModel.FlashService.IFlashCardService>, FlashCards.ViewModel.FlashService.IFlashCardService {
            
            public FlashCardServiceClientChannel(System.ServiceModel.ClientBase<FlashCards.ViewModel.FlashService.IFlashCardService> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginUploadFile(FlashCards.ViewModel.FlashService.UploadFileContentMessage request, System.AsyncCallback callback, object asyncState) {
            ...
            public FlashCards.ViewModel.FlashService.UploadFileTokenMessage EndUploadFile(System.IAsyncResult result) {
                object[] _args = new object[0];
                FlashCards.ViewModel.FlashService.UploadFileTokenMessage _result = ((FlashCards.ViewModel.FlashService.UploadFileTokenMessage)(base.EndInvoke("UploadFile", _args, result)));
                return _result;
            }
