...
namespace Aspose.Pdf.GridViewExport
{
    ...
    public class ExportGridViewToPdf : GridView, INamingContainer, IPostBackDataHandler
    {
        ...
        {
            get { return ViewState["Aspose_ExportDataSource"]; }
        ...
        private void CreateExportButton()
        {
            ...
            {
                Text = string.IsNullOrEmpty(ExportButtonText) ? "Export to Pdf" : ExportButtonText,
                ID = "__aspose_export_to_pdf_gridview",
                CssClass = ExportButtonCssClass
            };
        ...
        protected void ExportButton_Click(object sender, EventArgs e)
        {
            ...
            {
                PageInfo = new PageInfo { Margin = new MarginInfo(10, 10, 10, 10) }
            };
            ...
            {
                var tempVal = htmlLoadOptions.PageInfo.Width;
                htmlLoadOptions.PageInfo.Width = htmlLoadOptions.PageInfo.Height;
                htmlLoadOptions.PageInfo.Height = tempVal;
            }
